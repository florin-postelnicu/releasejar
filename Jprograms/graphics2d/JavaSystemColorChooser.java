...
public class JavaSystemColorChooser {
    public static void main(String[] args) {
        // set the frame , title , and exit button
        JFrame frame = new JFrame("JColorChooser Cusrom Panel Sample");
        ...
        ActionListener actionListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                // Abstract ColorChooserPanel chooserPanels[] = {newChooser};
                // color.Chooser.setChooserPanels(chooserPanels);
                ...
                // Fo cancel button selection, change button background to red
...
class SystemColorChooserPanel extends AbstractColorChooserPanel implements ItemListener {
    ...
    String labels[] = { "black", "blue", "cyan", "darkGray", "gray", "green", "lightGray", "magenta", "orange", "pink",
            "red", "white", "yellow", "activeCaption", "activeCaptionBorder", "activeCaptionText", "control",
            "controlDkShadow", "controlHighlight", "controlLtHighlight", "controlShadow", "controlText", "desktop",
            "inactiveCaption", "inactiveCaptionBorder", "inactiveCaptionText", "info", "infoText", "menu", "menuText",
            "scrollbar", "text", "textHighlight", "textHighlightText", "textInactiveText", "textText", "window",
    ...
    Color colors[] = { Color.black, Color.blue, Color.cyan, Color.darkGray, Color.gray, Color.green, Color.lightGray,
            Color.magenta, Color.orange, Color.pink, Color.red, Color.white, Color.yellow, SystemColor.activeCaption,
            SystemColor.activeCaptionBorder, SystemColor.activeCaptionText, SystemColor.control,
            SystemColor.controlDkShadow, SystemColor.controlHighlight, SystemColor.controlLtHighlight,
            SystemColor.controlShadow, SystemColor.controlText, SystemColor.desktop, SystemColor.inactiveCaption,
